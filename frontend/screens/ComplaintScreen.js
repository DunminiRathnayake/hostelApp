          ...
          <>
            ...
            <Animated.View style={[styles.formWrap, {
              ...
              <View style={[styles.formCard, T.cardShadow]}>
                ...
                {/* Description */}
                <Text style={[T.label, { marginTop: 18, zIndex: -1 }]}>DESCRIPTION</Text>
...
const styles = StyleSheet.create({
  ...
  descWrapFocused: { borderColor: colors.primary, shadowColor: colors.primary, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 2 },
  descInput: { padding: 14, minHeight: 110, textAlignVertical: "top", fontSize: 15, color: colors.textPrimary },
